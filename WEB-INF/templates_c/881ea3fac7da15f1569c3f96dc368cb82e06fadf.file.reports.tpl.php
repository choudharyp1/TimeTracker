<?php /* Smarty version Smarty-3.0.7, created on 2018-08-29 23:48:44
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/timetracker/WEB-INF/templates/reports.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1743604975b8714bc5f76f9-71318951%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '881ea3fac7da15f1569c3f96dc368cb82e06fadf' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/timetracker/WEB-INF/templates/reports.tpl',
      1 => 1529900086,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1743604975b8714bc5f76f9-71318951',
  'function' => 
  array (
  ),
...
<?php if ($_smarty_tpl->getVariable('user')->value->isPluginEnabled('iv')){?>
        <tr>
          ...
          <td>&nbsp;</td>
  <?php if ($_smarty_tpl->getVariable('user')->value->can('manage_invoices')){?>
...
<?php }?>
<?php if ($_smarty_tpl->getVariable('user')->value->can('view_reports')||$_smarty_tpl->getVariable('user')->value->can('view_all_reports')||$_smarty_tpl->getVariable('user')->value->isClient()){?>
        <tr>
...
<?php if ($_smarty_tpl->getVariable('user')->value->can('view_reports')||$_smarty_tpl->getVariable('user')->value->can('view_all_reports')||$_smarty_tpl->getVariable('user')->value->isPluginEnabled('cl')||$_smarty_tpl->getVariable('user')->value->isPluginEnabled('iv')||$_smarty_tpl->getVariable('user')->value->isPluginEnabled('ps')){?>
              <tr>
...
&nbsp;<?php echo $_smarty_tpl->getVariable('i18n')->value['label']['client'];?>
  ...
  <?php }?>
  <?php if (($_smarty_tpl->getVariable('user')->value->can('manage_invoices')||$_smarty_tpl->getVariable('user')->value->isClient())&&$_smarty_tpl->getVariable('user')->value->isPluginEnabled('iv')){?>
...
&nbsp;<?php echo $_smarty_tpl->getVariable('i18n')->value['label']['paid'];?>
  ...
  <?php }?>
  <?php if ($_smarty_tpl->getVariable('user')->value->can('view_reports')||$_smarty_tpl->getVariable('user')->value->can('view_all_reports')){?>
...
<?php if (($_smarty_tpl->getVariable('user')->value->can('manage_invoices')||$_smarty_tpl->getVariable('user')->value->isClient())||$_smarty_tpl->getVariable('user')->value->isPluginEnabled('ex')){?>
