<?php /* Smarty version Smarty-3.0.7, created on 2018-08-28 07:29:45
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/timetracker/WEB-INF/templates/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1957577685b84ddc901aa34-70411177%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1c8f836c07f18c883d7c4efec9a01909a8785f00' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/timetracker/WEB-INF/templates/header.tpl',
      1 => 1535434182,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1957577685b84ddc901aa34-70411177',
  'function' => 
  array (
  ),
...
" border="0">
                            <tr>
                                <td valign="top">
                                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                        <tr>
                                            <td height="6" colspan="2"><img width="1" height="6" src="images/1x1.gif"
                                                                            border="0"></td>
                                        </tr>
                                        <tr valign="top">
                                            <?php if ($_smarty_tpl->getVariable('user')->value->custom_logo){?>
                                                <td height="55" align="center"><img alt="Time Tracker" width="300"
                                                                                    height="43" src="<?php echo $_smarty_tpl->getVariable('custom_logo')->value;?>
"
                                                                                    border="0"></a></td>
                                            <?php }else{ ?>
...
"
  ...
  <span class="glyphicon glyphicon-th-list"></span></a> &middot;
...
"
  ...
  <span class="glyphicon glyphicon-time"></span></a>
                                ...
                                <?php if ($_smarty_tpl->getVariable('user')->value->isPluginEnabled('ex')&&($_smarty_tpl->getVariable('user')->value->can('track_own_expenses')||$_smarty_tpl->getVariable('user')->value->can('track_expenses'))){?>
                                    &middot;
                                    <a class="mainMenu" href="expenses.php"><?php echo $_smarty_tpl->getVariable('i18n')->value['menu']['expenses'];?>
</a>
                                <?php }?>
                                <?php if ($_smarty_tpl->getVariable('user')->value->can('view_own_reports')||$_smarty_tpl->getVariable('user')->value->can('view_reports')){?>
                                    &middot;
                                    <a class="mainMenu" href="reports.php"><?php echo $_smarty_tpl->getVariable('i18n')->value['menu']['reports'];?>
  <span class="glyphicon glyphicon-file"></span></a>
                                ...
                                <?php if ($_smarty_tpl->getVariable('user')->value->isPluginEnabled('iv')&&($_smarty_tpl->getVariable('user')->value->can('view_own_invoices')||$_smarty_tpl->getVariable('user')->value->can('manage_invoices'))){?>
                                    &middot;
                                    <a class="mainMenu" href="invoices.php"><?php echo $_smarty_tpl->getVariable('i18n')->value['title']['invoices'];?>
</a>
                                <?php }?>
                                <?php if (($_smarty_tpl->getVariable('user')->value->isPluginEnabled('ch')&&($_smarty_tpl->getVariable('user')->value->can('view_own_charts')||$_smarty_tpl->getVariable('user')->value->can('view_charts')))&&(@MODE_PROJECTS==$_smarty_tpl->getVariable('user')->value->tracking_mode||@MODE_PROJECTS_AND_TASKS==$_smarty_tpl->getVariable('user')->value->tracking_mode||$_smarty_tpl->getVariable('user')->value->isPluginEnabled('cl'))){?>
                                    &middot;
                                    <a class="mainMenu" href="charts.php"><?php echo $_smarty_tpl->getVariable('i18n')->value['menu']['charts'];?>
</a>
                                <?php }?>
                                <?php if (($_smarty_tpl->getVariable('user')->value->can('view_own_projects')||$_smarty_tpl->getVariable('user')->value->can('manage_projects'))&&(@MODE_PROJECTS==$_smarty_tpl->getVariable('user')->value->tracking_mode||@MODE_PROJECTS_AND_TASKS==$_smarty_tpl->getVariable('user')->value->tracking_mode)){?>
                                    &middot;
                                    <a class="mainMenu" href="projects.php"><?php echo $_smarty_tpl->getVariable('i18n')->value['menu']['projects'];?>
  <span class="glyphicon glyphicon-stats"></span></a>
                                ...
                                <?php if ((@MODE_PROJECTS_AND_TASKS==$_smarty_tpl->getVariable('user')->value->tracking_mode&&($_smarty_tpl->getVariable('user')->value->can('view_own_tasks')||$_smarty_tpl->getVariable('user')->value->can('manage_tasks')))){?>
                                    &middot;
                                    <a class="mainMenu" href="tasks.php"><?php echo $_smarty_tpl->getVariable('i18n')->value['menu']['tasks'];?>
  <span class="glyphicon glyphicon-tasks"></span></a>
                                ...
                                <?php if ($_smarty_tpl->getVariable('user')->value->can('view_users')||$_smarty_tpl->getVariable('user')->value->can('manage_users')){?>
                                    &middot;
                                    <a class="mainMenu" href="users.php"><?php echo $_smarty_tpl->getVariable('i18n')->value['menu']['users'];?>
  <span class="glyphicon glyphicon-user"></span></a>
                                ...
                                <?php if ($_smarty_tpl->getVariable('user')->value->isPluginEnabled('cl')&&($_smarty_tpl->getVariable('user')->value->can('view_own_clients')||$_smarty_tpl->getVariable('user')->value->can('manage_clients'))){?>
                                    &middot;
                                    <a class="mainMenu" href="clients.php"><?php echo $_smarty_tpl->getVariable('i18n')->value['menu']['clients'];?>
</a>
                                <?php }?>
                                <?php if ($_smarty_tpl->getVariable('user')->value->can('export_data')){?>
                                    &middot;
                                    <a class="mainMenu" href="export.php"><?php echo $_smarty_tpl->getVariable('i18n')->value['menu']['export'];?>
 ...
 <span class="glyphicon glyphicon-log-in"></span></a> &middot;
...
" border="0">
                    <tr>
                        <td class="sectionHeader">
                            <div class="pageTitle"><?php echo $_smarty_tpl->getVariable('title')->value;?>
...
<?php }?></div>
                    ...
                    <?php if ($_smarty_tpl->getVariable('user')->value->name){?>
                        <tr>
                            <td><b><?php echo smarty_modifier_escape($_smarty_tpl->getVariable('user')->value->name);?>
 - <?php echo smarty_modifier_escape($_smarty_tpl->getVariable('user')->value->role_name);?>
<?php if ($_smarty_tpl->getVariable('user')->value->behalf_id>0){?>
                                        <b><?php echo $_smarty_tpl->getVariable('i18n')->value['label']['on_behalf'];?>
