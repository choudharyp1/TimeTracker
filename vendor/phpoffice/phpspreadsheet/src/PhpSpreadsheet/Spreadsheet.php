...
class Spreadsheet
{
    ...
    public function addSheet(Worksheet $pSheet, $iSheetIndex = null)
    {
        if ($this->sheetNameExists($pSheet->getTitle())) {
            echo"<pre>"; var_dump($pSheet); die(__FILE__.':'.__LINE__);
            throw new Exception(
...
//            echo"<pre>"; var_dump($iSheetIndex); die(__FILE__.':'.__LINE__);
...
//        echo"<pre>"; var_dump($iSheetIndex); die(__FILE__.':'.__LINE__);
    ...
    {
        $worksheetCount = count($this->workSheetCollection);
//        echo"<pre>"; var_dump($worksheetCount); die(__FILE__.':'.__LINE__);
        for ($i = 0; $i < $worksheetCount; ++$i) {
            if ($this->workSheetCollection[$i]->getTitle() === $pName) {
//                echo"<pre>"; var_dump($var); die(__FILE__.':'.__LINE__);
                return $this->workSheetCollection[$i];
            }
        }
//        echo"<pre>"; var_dump($var); die(__FILE__.':'.__LINE__);
